...
> Snapshot 1
    ...
    ␊
    export type GetCalculationIdFetchResponse = ␊
    | FetchResponse<CalculationDto, 200> ␊
    | FetchResponse<ProblemDetails, 403> ␊
    | ErrorResponse;␊
    ␊
    export const getCalculationId = (id: number, CalculationID?: number, headers = new Headers()): ␊
    	Promise<GetCalculationIdFetchResponse> => {␊
    	const queryParams = {␊
    		"Calculation.ID": CalculationID␊
    	}␊
    	return apiGet(\`${API_URL}/api/Calculation/${id}\`, headers, queryParams) as Promise<GetCalculationIdFetchResponse>;␊
    }␊
    ␊
    export type DeleteCalculationIdFetchResponse = ␊
    | FetchResponse<EntityResult, 200> ␊
    | FetchResponse<ProblemDetails, 403> ␊
    | FetchResponse<ProblemDetails | HttpValidationProblemDetails, 404> ␊
    | ErrorResponse;␊
    ␊
    export const deleteCalculationId = (id: number, headers = new Headers()): ␊
    	Promise<DeleteCalculationIdFetchResponse> => {␊
    	return apiDelete(\`${API_URL}/api/Calculation/${id}\`, headers, {}) as Promise<DeleteCalculationIdFetchResponse>;␊
    }␊
    ␊
    export type GetCalculationIdOverviewFetchResponse = ␊
    | FetchResponse<FileResponse, 200> ␊
    | FetchResponse<void, 204> ␊
    | ErrorResponse;␊
    ␊
    export const getCalculationIdOverview = (id: number, headers = new Headers()): ␊
    	Promise<GetCalculationIdOverviewFetchResponse> => {␊
    	return apiGet(\`${API_URL}/api/Calculation/${id}/overview\`, headers, {}) as Promise<GetCalculationIdOverviewFetchResponse>;␊
    }␊
    ␊
    export const API = { ␊
    	getCalculationId,␊
