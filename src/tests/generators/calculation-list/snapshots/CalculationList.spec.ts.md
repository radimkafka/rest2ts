...
> Snapshot 1
    ...
    ␊
    export type CalculationListItemDto = {␊
    ...
    ␊
    export type PostCalculationListFetchResponse = ␊
    | FetchResponse<CalculationListItemDto[], 200> ␊
    | FetchResponse<ProblemDetails, 401> ␊
    | ErrorResponse;␊
    ␊
    export const postCalculationList = (requestContract: CalculationFilter, headers = new Headers()): ␊
    	Promise<PostCalculationListFetchResponse> => {␊
    	return apiPost(\`${API_URL}/api/Calculation/list\`, requestContract, headers) as Promise<PostCalculationListFetchResponse>;␊
    }␊
    ␊
    export const API = { ␊
    	postCalculationList␊
...
> Snapshot 1
    ...
    ␊
      ␊
    	␊
        postCalculationList(requestContract: CalculationFilter): Observable<ResponseResult<CalculationListItemDto[], 200> | ResponseResult<ProblemDetails, 401>> {␊
    	␊
          return apiPost<ResponseResult<CalculationListItemDto[], 200> | ResponseResult<ProblemDetails, 401>>(this.httpClient, \`${this.baseUrl}/api/Calculation/list\`, requestContract);␊
        }␊
      ␊
    ␊
    ␊
