# Snapshot report for `src/tests/generators/session/Session.spec.ts`

The actual snapshot is saved in `Session.spec.ts.snap`.
...
> Snapshot 1
    ...
    export const API_ROUTES = { ␊
    	postVerify: "/verify",␊
    	putCountryCodeSessionsSessionId: "/{countryCode}/Sessions/{sessionId}"␊
    }␊
    ␊
    export type Session = {␊
    	sessionId: string;␊
    ...
    export const postVerify = (body: string, headers = new Headers()): ␊
    	...
    	return apiPost(\`${API_URL}/verify\`, body, headers) as Promise<PostVerifyFetchResponse>;␊
    }␊
    ␊
    ...
    | ErrorResponse;␊
    ␊
    export const putCountryCodeSessionsSessionId = (requestContract: Session, sessionId: string, countryCode: CountryCode, lang?: string, headers = new Headers()): ␊
    	Promise<PutCountryCodeSessionsSessionIdFetchResponse> => {␊
    	const queryParams = {␊
    		"lang": lang␊
    	}␊
    	return apiPut(\`${API_URL}/${countryCode}/Sessions/${sessionId}\`, requestContract, headers, queryParams) as Promise<PutCountryCodeSessionsSessionIdFetchResponse>;␊
    }␊
    ␊
    export const API = { ␊
    	postVerify,␊
    	putCountryCodeSessionsSessionId␊
    }␊
    ␊
    `

## Angular parse session
...
> Snapshot 1
    ...
    ␊
      ␊
    	...
    	␊
          return apiPost<ResponseResult<void, 200>>(this.httpClient, \`${this.baseUrl}/verify\`, body);␊
        }␊
      ␊
    ␊
        putCountryCodeSessionsSessionId(requestContract: Session, sessionId: string, countryCode: CountryCode, lang?: string): Observable<ResponseResult<Session, 200>> {␊
    	const queryParams = {␊
    		"lang": lang␊
    	}␊
    	␊
          return apiPut<ResponseResult<Session, 200>>(this.httpClient, \`${this.baseUrl}/${countryCode}/Sessions/${sessionId}\`, requestContract, queryParams);␊
        }␊
      ␊
    ␊
    ␊
