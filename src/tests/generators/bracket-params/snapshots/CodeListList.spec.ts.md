# Snapshot report for `src/tests/generators/bracket-params/CodeListList.spec.ts`

The actual snapshot is saved in `CodeListList.spec.ts.snap`.

Generated by [AVA](https://avajs.dev).

## parser bracket params
...
> Snapshot 1
    ...
    export type ProducerItemDTO = {␊
    	id: number;␊
    	title: string;␊
    	commisionTransfer: "None" | "TransferWithBreakdown" | "TransferWithoutBreakdown";␊
    };␊
    ␊
    ...
    "filter[category]": filterCategory␊
    	...
    	return apiGet(\`${API_URL}/api/producers\`, headers, queryParams) as Promise<GetProducersFetchResponse>;␊
    }␊
    ␊
    export const API = { ␊
    	getProducers␊
